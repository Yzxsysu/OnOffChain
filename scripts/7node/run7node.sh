...
case $nodeId in
    ...
    ;;
    -1)
    ./build/offchain/offchain -accountNum 100000 -webIp "172.172.0.4,172.172.0.5,172.172.0.6,172.172.0.7,172.172.0.8,172.172.0.9" -webPort "10157,10157,10157,10157,10157,10157" -offChainIp "0.0.0.0" -offChainPort "8090" -SetNum "$division" &> $LOG_DIR/offchain.log &
    echo "the node Id is ${nodeId}, offchain node"
    ;;
esac
