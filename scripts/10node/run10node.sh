...
case $nodeId in
    ...
    ;;
    -1)
    ./build/offchain/offchain -accountNum 1000 -webIp "172.172.0.4,172.172.0.5,172.172.0.6,172.172.0.7,172.172.0.8,172.172.0.9,172.172.0.10,172.172.0.11,172.172.0.12" -webPort "10157,10157,10157,10157,10157,10157,10157,10157,10157" -offChainIp "127.0.0.1" -offChainPort "8090" -SetNum "$division" &> $LOG_DIR/offchain.log &
